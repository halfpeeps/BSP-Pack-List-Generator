...
if __name__ == "__main__":
    ...
    target_directory = r"X:\Perpheads\night-pack"
    ...
    folders = [
        ...
        r"\materials\materials_infra",
        r"\materials\models\jarheads\props\skybox",
        r"\materials\models\jarheads\props\SkyboxPowerplant3",
        r"\materials\models\jarheads\props\churchwindow",
        r"\materials\models\jarheads\props\cornerstore_sign",
        r"\materials\models\jarheads\props\jarheads",
        r"\materials\models\jarheads\props\tinyelec_largewindow",
        r"\materials\models\propper",
        r"\materials\models\props",
        r"\materials\models\props_infra/sky",
        r"\materials\models\props_foliage",
        r"\materials\models\props_infra",
        r"\materials\models\small_props",
        r"\materials\models\stephenpuffs",
        r"\materials\models\update1",
        r"\materials\xq\decals",
        r"\materials\xq\racing",
        r"\models\ayjay",
        r"\models\jarheads",
        r"\models\props",
